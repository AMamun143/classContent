...
var isPangram = function(string){
  //If the string contains less than 26 letters, it couldnt have all 26 letters of the alphabet
  if(string.length < 26){
    return false;
  } else {
    ...
    //Make the string lowercase, remove anything that isnt the letters a through z, then split them into an array
